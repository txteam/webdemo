...
public class HttpClientUtils {
    ...
    static {
        ...
        props.setConnectionTimeout(3000);
        props.setConnectionTimerRepeat(3000 * 3);
        ...
        }, props.getConnectionTimeout() * 3, props.getConnectionTimerRepeat());
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .setSocketTimeout(props.getConnectionTimeout() * 2)
                .build();
    ...
    public static CloseableHttpClient buildHttpClient(
        ...
        PoolingHttpClientConnectionManager manager = new PoolingHttpClientConnectionManager(
                registry, null, null, null, props.getTimeToLive(),
                props.getTimeToLiveUnit());
        manager.setMaxTotal(props.getMaxConnections());
        manager.setDefaultMaxPerRoute(props.getMaxConnectionsPerRoute());
        Timer timer = new Timer("HttpClientUtils.connectionManagerTimer", true);
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                manager.closeExpiredConnections();
            }
        }, props.getConnectionTimeout() * 10, props.getConnectionTimerRepeat());
        ...
        CloseableHttpClient client = HttpClientBuilder.create()
                ...
                .setConnectionManagerShared(true)
                .setDefaultRequestConfig(requestConfig)
                .setRetryHandler(new DefaultHttpRequestRetryHandler(30, true))
                .build();
        return client;
    }
    ...
    public static String post(CloseableHttpClient client, String url,
        ...
        String result = post(client, url, msg, "UTF-8", "UTF-8");
        return result;
    }
     ...
     */
    public static String post(CloseableHttpClient client, String url,
            String msg, String requestEncoding, String responseEncoding) {
        return post(client, url, msg, requestEncoding, responseEncoding, null);
    }
    ...
    public static String post(CloseableHttpClient client, String url,
        ...
        String result = post(client, url, params, "UTF-8", "UTF-8", null);
        return result;
    }
     ...
     */
    public static String post(CloseableHttpClient client, String url,
            Map<String, String> params, String requestEncoding,
            String responseEncoding) {
        String result = post(client,
                url,
                params,
                requestEncoding,
                responseEncoding,
    ...
    public static String get(CloseableHttpClient client, String url,
            Map<String, String> params) {
        String result = get(client, url, params, "UTF-8", "UTF-8", null);
        return result;
    }
