...
public class TestDemoCodeGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //生成页面
        CodeGenerator.generateView(entityType, ViewTypeEnum.LIST);
        CodeGenerator.generateView(entityType, ViewTypeEnum.TREELIST);
        CodeGenerator.generateView(entityType, ViewTypeEnum.PAGEDLIST);
