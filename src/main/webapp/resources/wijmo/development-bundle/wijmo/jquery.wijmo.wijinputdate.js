...
/// <reference path="jquery.wijmo.wijwidget.ts"/>
...
(function (wijmo) {
    ...
    var wijinputdate = (function (_super) {
        ...
        wijinputdate.prototype._beginUpdate = function () {
            ...
            this.element.addClass('wijmo-wijinput-date').attr({
        ...
        wijinputdate.prototype._onTriggerClicked = function () {
        ...
        wijinputdate.prototype._keyPressPreview = function (e) {
            ...
            if(range) {
                ...
                ret = this._textProvider.addToField(ch, this.options.activeField, pos, !newAction);
                if(ret) {
                    this._updateText();
        ...
        wijinputdate.prototype._initCalendar = function () {
            ...
            calendar.wijcalendar({
                ...
                selectedDatesChanged: function () {
                    var selDate = calendar.wijcalendar("getSelectedDate");
        ...
        wijinputdate.prototype._popupOrHideCalendar = function () {
            if(!this._allowEdit()) {
                return;
            }
            var calendar = this.element.data('calendar');
    ...
    wijinputdate.prototype.options = $.extend(true, {
        ...
        /// Type: Function.
        /// Code example:
        /// $("#element").wijinputdate({ dateChanged(e, arg) { } });
        /// </summary>
        ///
    ...
    $.widget("wijmo.wijinputdate", wijinputdate.prototype);
    var wijDateTextProvider = (function (_super) {
        ...
        wijDateTextProvider.prototype._internalSetDate = function (date) {
            if(this.inputWidget) {
                ...
                var inputElement = this.inputWidget.element;
                var typing = !!inputElement.data('typing');
                var chkBounds;
                ...
                if(typing) {
                    ...
                    chkBounds = function () {
                        var now = new Date();
                        var lastTime = inputElement.data('timeStamp');
        ...
        wijDateTextProvider.prototype.addToField = function (input, activeField, pos, append) {
            ...
            txt = append ? desc.getText() + input : input;
            resultObj = {
                val: input,
                pos: 0,
                offset: 0,
        ...
        wijDateTextProvider.prototype.insertAt = function (input, position, rh) {
            ...
            var pos;
            var txt;
            var tryToExpandAtRight;
            var result;
            var tryToExpandAtLeft;
            var curInsertTxt;
            var resultObj;
            var prevTextLength;
            var posAdjustValue;
        ...
        wijDateTextProvider.prototype.removeAt = function (start, end, rh) {
            try  {
                ...
                var resultObj;
                var result;
                var widget = this.inputWidget;
                var element = widget.element;
                var dateLength = element.val().length;
        ...
        wijDateTextProvider.prototype._formatDate = function (date, format, culture) {
            ...
            var cf = this.inputWidget._getCulture().calendars.standard;
            var sRes = format.replace(new RegExp('yyyy|MMMM|MMM|MM|M|mm|m|dddd|ddd|dd|d|hh|h|HH|H|ss|s|tt|t|a/p', 'gi'), function (match) {
                var h;
                switch(match) {
                    case 'yyyy': {
    ...
    var _dateDescriptor26 = (function (_super) {
        ...
        _dateDescriptor26.prototype.setText = function (value, allowchangeotherpart, result) {
            var m = -1;
            var cf = this._txtProvider.inputWidget._getCulture().calendars.standard;
    ...
    var _dateDescriptor250 = (function (_super) {
        ...
        _dateDescriptor250.prototype.getText = function () {
            ...
            var culture = this._txtProvider._getCulture();
            var designator = culture.calendars.standard[hours < 12 ? "AM" : "PM"][0];
