...
(function (wijmo) {
    ...
    var wijinputcore = (function (_super) {
        ...
        wijinputcore.prototype._create = function () {
            ...
            this._initialize();
            this.outerDiv.width(this.element.width());
            borderWidth = this.element.leftBorderWidth() + this.element.rightBorderWidth();
            this.element.width(this.outerDiv.width() - borderWidth);
        };
        ...
        wijinputcore.prototype._setOption = function (key, value) {
            ...
            switch(key) {
                ...
                case 'disabled': {
                    ...
                    var stateDisabled = this.namespace + "-state-disabled";
        ...
        wijinputcore.prototype._raiseTextChanged = function () {
            ...
            var preText = this.element.data('preText');
        ...
        wijinputcore.prototype._fireIvalidInputEvent = function (chr) {
            ...
            if($.isFunction(self.options.invalidInput) && self._trigger('invalidInput', null, {
                widget: self,
                char: chr
            }) === true) {
                return;
        ...
        wijinputcore.prototype._calcSpinInterval = function () {
            ...
            if(this._repeatingCount > 10) {
                ...
                if(this._repeatingCount > 4) {
                    return 100;
                } else {
                    if(this._repeatingCount > 2) {
                        return 200;
                    }
                }
            }
        ...
        wijinputcore.prototype._popupComboList = function () {
            ...
            if(this._comboDiv === undefined) {
                this._comboDiv = $("<div></div>").appendTo(document.body).width(this.outerDiv.width()).height(this.options.comboHeight || 180).css('position', 'absolute');
