<link rel="stylesheet" type="text/css" href="${contextPath }/css/commons_.css" />

<script type="text/javascript" src="${contextPath }/js/jquery-1.8.2.js"></script>
<script type="text/javascript" src="${contextPath }/jquery-ui/js/jquery-ui-1.8.24.custom.min.js"></script>
