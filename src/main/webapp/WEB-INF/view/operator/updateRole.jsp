...
$(document).ready(function(){
	...
	$('#roleForm').validator({
	    valid: function(){
			...
			$('#roleForm').ajaxSubmit({
			    url:"${contextPath }/role/updateRole.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("修改role成功");
						parent.DialogUtils.closeDialogById("updateRole");
					}else{
						parent.DialogUtils.tip("修改role失败");
					}
			    } 
			});
			return false;
		...
		<form:form id="roleForm" method="post" cssClass="form"
			...
			<table class="common_table">
				<tr>
					...
					<th class="narrow" width="30%">所属业务中心:<span class="tRed">*</span></th>
					<td>
