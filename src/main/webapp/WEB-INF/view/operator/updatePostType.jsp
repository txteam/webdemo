	...
	$('#postTypeForm').validator({
	    valid: function(){
			...
			$('#postTypeForm').ajaxSubmit({
			    url:"${contextPath }/postType/updatePostType.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("修改postType成功");
						parent.DialogUtils.closeDialogById("updatePostType");
					}else{
						parent.DialogUtils.tip("修改postType失败");
					}
			    } 
			});
			return false;
		...
		<form:form id="postTypeForm" method="post" cssClass="form"
			...
			<table class="common_table">
				<tr>
					...
					<th class="narrow" width="20%">name:<span class="tRed">*</span></th>
					<td width="80%">
