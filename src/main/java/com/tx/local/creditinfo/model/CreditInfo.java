...
public interface CreditInfo extends Serializable {
    ...
    */
     ...
     * 设置最后更新时间<br/>
     * <功能详细描述>
     * @param createOperatorId [参数说明]
     * 
     * @return void [返回类型说明]
     * @exception throws [异常类型] [异常说明]
     * @see [类、类#方法、类#成员]
    */
    void setCreateOperatorId(String createOperatorId);
    ...
    /**
      ...
      * @see [类、类#方法、类#成员]
     */
    String getLastUpdateOperatorId();
    
    /**
     * 设置最后更新人id<br/>
     * <功能详细描述>
     * @param lastUpdateOperatorId [参数说明]
     * 
     * @return void [返回类型说明]
     * @exception throws [异常类型] [异常说明]
     * @see [类、类#方法、类#成员]
    */
    void setLastUpdateOperatorId(String lastUpdateOperatorId);
}
