 ...
 * @since  [产品/模块版本]
 */
public abstract class CreditInfo implements Serializable {
     ...
     */
    public CreditInfoTypeEnum getVersionType() {
        return versionType;
    }
     ...
     */
    public void setVersionType(CreditInfoTypeEnum versionType) {
