 ...
 * @since  [产品/模块版本]
 */
public class DefaultCreditMultipLinkedServiceImpl<T extends CreditMultipLinked>
        implements CreditMultipLinkedService<T>, InitializingBean {
    ...
    /** 默认的信用信息链接 */
    public DefaultCreditMultipLinkedServiceImpl(Class<T> type) {
        super();
        this.type = type;
    }
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.pdMap = new HashMap<String, PropertyDescriptor>();
