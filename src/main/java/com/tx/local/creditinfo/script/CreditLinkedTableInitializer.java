 ...
 * <修改描述:>
 */
package com.tx.local.creditinfo.script;
 ...
 * @since  [产品/模块版本]
 */
public class CreditLinkedTableInitializer extends AbstractTableInitializer
    ...
    /** <默认构造函数> */
    public CreditLinkedTableInitializer() {
        super();
    }
    
    /** <默认构造函数> */
    public CreditLinkedTableInitializer(TableDDLExecutor tableDDLExecutor) {
        super();
    ...
    public String tables(TableDDLExecutor tableDDLExecutor,
        ...
        Set<Class<? extends CreditLinked>> typeSet = ClassScanUtils
                .scanByParentClass(CreditLinked.class, basePackageArray);
        
        StringBuilder sb = new StringBuilder();
        for (Class<? extends CreditLinked> type : typeSet) {
            ...
            //}
            ////版本类型
            //for (CreditInfoTypeEnum versionType : CreditInfoTypeEnum.values()) {
            //String tableName = versionType.getPrefix() + tableNameTemp;
            String tableName = tableNameTemp;
