 ...
 * @since  [产品/模块版本]
 */
public class CreditInfoTableInitializer extends AbstractTableInitializer
    ...
    /** <默认构造函数> */
    public CreditInfoTableInitializer() {
        super();
    }
    
    /** <默认构造函数> */
    public CreditInfoTableInitializer(TableDDLExecutor tableDDLExecutor) {
        super();
