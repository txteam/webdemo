...
public class VirtualCenterService {
    ...
    public void insert(VirtualCenter virtualCenter) {
		...
		AssertUtils.notEmpty(virtualCenter.getCode(), "virtualCenter.code is empty.");
		AssertUtils.notEmpty(virtualCenter.getName(), "virtualCenter.name is empty.");
		AssertUtils.notEmpty(virtualCenter.isModifyAble(), "virtualCenter.modifyAble is empty.");
    ...
    public PagedList<VirtualCenter> queryPagedList(
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        PagedList<VirtualCenter> resPagedList = this.virtualCenterDao.queryPagedList(params, pageIndex, pageSize);
    ...
    public PagedList<VirtualCenter> queryPagedList(
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        PagedList<VirtualCenter> resPagedList = this.virtualCenterDao.queryPagedList(querier, pageIndex, pageSize);
    ...
    public boolean updateById(VirtualCenter virtualCenter) {
        //验证参数是否合法，必填字段是否填写
        AssertUtils.notNull(virtualCenter, "virtualCenter is null.");
        AssertUtils.notEmpty(virtualCenter.getId(), "virtualCenter.id is empty.");
    ...
    public List<VirtualCenter> queryDescendantsByParentId(String parentId,
        ...
        List<VirtualCenter> resList = doNestedQueryChildren(valid, ids, parentIds, params);
        return resList;
    }
     ...
     * @see [类、类#方法、类#成员]
     */
    private List<VirtualCenter> doNestedQueryChildren(
			Boolean valid,
    ...
    public List<VirtualCenter> queryDescendantsByParentId(String parentId,
        ...
        List<VirtualCenter> resList = doNestedQueryChildren(valid, ids, parentIds, querier);
        return resList;
    }
