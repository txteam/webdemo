...
public class VirtualCenterAPIController implements VirtualCenterFacade {
    ...
    public int count(
			@RequestParam(value = "valid", required = false) Boolean valid,
            @RequestBody Querier querier) {
        int count = this.virtualCenterService.count(
			valid,
        	querier);
    ...
    public List<VirtualCenter> queryChildrenByParentId(@PathVariable(value = "parentId", required = true) String parentId,
			@RequestParam(value = "valid", required = false) Boolean valid,
            Querier querier){
        List<VirtualCenter> resList = this.virtualCenterService.queryChildrenByParentId(parentId,
			valid,
			querier         
        );
    ...
    public List<VirtualCenter> queryDescendantsByParentId(@PathVariable(value = "parentId", required = true) String parentId,
			@RequestParam(value = "valid", required = false) Boolean valid,
            Querier querier){
        List<VirtualCenter> resList = this.virtualCenterService.queryDescendantsByParentId(parentId,
			valid,
			querier         
        );
