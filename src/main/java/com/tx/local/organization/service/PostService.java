...
import com.tx.local.organization.dao.PostDao;
...
public class PostService {
    ...
    public void insert(Post post) {
        ...
        AssertUtils.notEmpty(post.getOrganizationId(),
                "post.organizationId is empty.");
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<Post> queryList(Boolean valid, Map<String, Object> params) {
        //判断条件合法性
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<Post> queryList(Boolean valid, Querier querier) {
        //判断条件合法性
     ...
     * @see [类、类#方法、类#成员]
     */
    public PagedList<Post> queryPagedList(Boolean valid,
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        PagedList<Post> resPagedList = this.postDao.queryPagedList(params,
                pageIndex,
                pageSize);
     ...
     * @see [类、类#方法、类#成员]
     */
    public PagedList<Post> queryPagedList(Boolean valid, Querier querier,
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        PagedList<Post> resPagedList = this.postDao.queryPagedList(querier,
                pageIndex,
                pageSize);
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<Post> queryChildrenByParentId(String parentId, Boolean valid,
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<Post> queryDescendantsByParentId(String parentId, Boolean valid,
            Map<String, Object> params) {
        //判断条件合法性
        AssertUtils.notEmpty(parentId, "parentId is empty.");
        ...
        List<Post> resList = doNestedQueryChildren(valid,
                ids,
                parentIds,
                params);
        return resList;
     ...
     * @see [类、类#方法、类#成员]
     */
    private List<Post> doNestedQueryChildren(Boolean valid, Set<String> ids,
    ...
    public boolean modifyAble(String id) {
        ...
        DateTime createDateTime = new DateTime(post.getCreateDate());
        Date now = new Date();
        //如果创建时间已经超过了一天
