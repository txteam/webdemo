 ...
 * @since [产品/模块版本]
 */
@Component("operSocialAccountDao")
public class OperSocialAccountDaoImpl 
		extends MybatisBaseDaoImpl<OperSocialAccount, String>
		implements OperSocialAccountDao {
