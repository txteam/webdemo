 ...
 * @since [产品/模块版本]
 */
@Component("operSecurityAccountDao")
public class OperSecurityAccountDaoImpl 
		extends MybatisBaseDaoImpl<OperSecurityAccount, String>
		implements OperSecurityAccountDao {
