 ...
 */
@Controller
@RequestMapping("/admin/operatorRole")
public class AdminOperatorRoleController {
    ...
    public String toQueryList(ModelMap response) {
        ...
        return "/operator/admin/queryOperatorRoleList";
    }
    ...
    public String toAdd(
        ...
        return "/operator/admin/addOperatorRole";
    }
    ...
    public String toUpdate(@RequestParam("id") String id, ModelMap response) {
        ...
        return "/operator/admin/updateOperatorRole";
    }
