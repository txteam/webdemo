...
@ApiModel("组织")
public class OperatorOrganization
        implements TreeAble<List<OperatorOrganization>, OperatorOrganization>, Serializable {
    ...
    private OperatorOrganization company;
    
    /** 部门id */
    @ApiModelProperty("部门")
    @Column(nullable = true, length = 64, name = "departmentId")
    private OperatorOrganization department;
    ...
    @Column(nullable = false, length = 64)
    private OperatorOrganizationTypeEnum type;
    ...
    /** 子级组织集合 */
    @Transient
    private List<OperatorOrganization> children;
     ...
     * @return 返回 type
     */
    public OperatorOrganizationTypeEnum getType() {
        return type;
    }
     ...
     * @param 对type进行赋值
     */
    public void setType(OperatorOrganizationTypeEnum type) {
        this.type = type;
    }
     ...
     * @return 返回 children
     */
    public List<OperatorOrganization> getChildren() {
        return children;
    }
     ...
     * @param 对children进行赋值
     */
    public void setChildren(List<OperatorOrganization> children) {
     ...
     * @return 返回 company
     */
    public OperatorOrganization getCompany() {
        return company;
    }
     ...
     * @param 对company进行赋值
     */
    public void setCompany(OperatorOrganization company) {
     ...
     */
    public OperatorOrganization getDepartment() {
        return department;
    }
     ...
     */
    public void setDepartment(OperatorOrganization department) {
