...
@ApiModel("职位")
public class OperatorPost implements TreeAble<List<OperatorPost>, OperatorPost>, Serializable {
    ...
    /** 子职位 */
    @Transient
    private List<OperatorPost> children;
    
    /**
     * @return 返回 childs
     */
    @Override
    public List<OperatorPost> getChildren() {
        return children;
    }
     ...
     */
    @Override
    public void setChildren(List<OperatorPost> children) {
