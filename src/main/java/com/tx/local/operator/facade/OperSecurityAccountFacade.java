...
/**
 * 操作人员账户安全设置接口门面层[OperSecurityAccountFacade]<br/>
 * 
 * @author []
 * @version [版本号]
 * @see [相关类/方法]
 * @since [产品/模块版本]
 */
public interface OperSecurityAccountFacade {
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "新增操作人员账户安全设置")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据ID删除操作人员账户安全设置")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "修改操作人员账户安全设置")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据主键查询操作人员账户安全设置")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询操作人员账户安全设置列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询操作人员账户安全设置分页列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询操作人员账户安全设置数量")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询操作人员账户安全设置是否存在")
