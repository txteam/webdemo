 ...
 * @since [产品/模块版本]
 */
public interface OperatorOrganizationFacade {
    ...
    public OperatorOrganization insert(
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据条件查询查询组织子代列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据条件查询查询组织后代列表")
