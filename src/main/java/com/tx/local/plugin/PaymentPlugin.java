...
//import com.tx.local.entity.UnionpayPaymentRecord;
//import com.tx.local.service.PaymentTransactionService;
...
//    public static final String MIN_PAY_AMOUNT = "minPayAmount";
//
//    /**
//     * 默认超时时间
//     */
...
//     * @return
//     */
//    public UnionpayPaymentRecord.Type getUnionPayHfType(){
//        return null;
//    }
//
//
...
//
//    /*
//     * 商家是否有账户直接收款；如在支付渠道开通了二级商户，钱直接进入到上级商户的账户中；
//     * 若没有，则使用余额进行标记
//     *
//     *
//     * @return
//     */
//    public boolean isBusinessDirectCollect(){
//        return true;
//    }
//
//    /**
...
//        PluginConfig pluginConfig = getPluginConfig();
//        if(pluginConfig != null && pluginConfig.getAttribute(FEE_TYPE_ATTRIBUTE_NAME)==null){
...
//        PluginConfig pluginConfig = getPluginConfig();
//        if(pluginConfig != null && pluginConfig.getAttribute(FEE_ATTRIBUTE_NAME)==null){
...
//        PluginConfig pluginConfig = getPluginConfig();
//        if(pluginConfig != null && pluginConfig.getAttribute(MIN_PAY_AMOUNT)==null){
//            return BigDecimal.ZERO;
//        }
//        return pluginConfig != null ? new BigDecimal(pluginConfig.getAttribute(MIN_PAY_AMOUNT)) : BigDecimal.ZERO;
//    }
//
//    /**
//     * 获取LOGO
...
//
//    public Map<String, Object> payHandleParam(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra, HttpServletRequest request, HttpServletResponse response) throws Exception {
//        ModelAndView modelAndView = new ModelAndView();
//        payHandle(paymentPlugin, paymentTransaction, paymentDescription, extra, request, response, modelAndView);
//
...
//    }
//
//    public boolean isRefundSuccessHandler(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra,
//                                          HttpServletRequest request, HttpServletResponse response) {
//        boolean res = isRefundSuccess(paymentPlugin, paymentTransaction, paymentDescription, extra, request, response);
//        if (res) {
//            paymentTransaction.setIsRefundsSuccess(true);
//            paymentTransactionService.update(paymentTransaction);
//        }
//        return res;
//    }
//
//    protected   boolean isRefundSuccess(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra,
//                                            HttpServletRequest request, HttpServletResponse response){
//        return false;
//    }
//
...
//
//
//    public final boolean refundHandle(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra,
//                                      HttpServletRequest request, HttpServletResponse response) {
//        boolean res = refund(paymentPlugin, paymentTransaction, paymentDescription, extra, request, response);
//        if (res) {
//            paymentTransaction.setIsRefunds(true);
//            paymentTransactionService.update(paymentTransaction);
//        }
//        return res;
//
//    }
//
//    protected boolean refund(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra,
//                             HttpServletRequest request, HttpServletResponse response) {
//        return false;
//    }
//
