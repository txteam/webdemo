 ...
 * @since  [产品/模块版本]
 */
public class OnceAgainLoanRequest extends AbstractLoanRequest {
    
    /** <默认构造函数> */
    public OnceAgainLoanRequest(LoanAccount loanAccount,
    ...
    public LATradingRecordTypeEnum getTradingRecordType() {
        return LATradingRecordTypeEnum.AGAIN_LOAN;
    }
}
