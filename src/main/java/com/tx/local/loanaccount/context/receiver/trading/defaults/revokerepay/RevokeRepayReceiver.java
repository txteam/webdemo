 ...
 * @since  [产品/模块版本]
 */
@Component("revokeRepayReceiver")
public class RevokeRepayReceiver extends AbstractRevokeRepayReceiver<RevokeRepayRequest> {
     ...
     */
    @Override
    public void validateRequest(RevokeRepayRequest request, CommandResponse response, LoanAccount loanAccount,
     ...
     */
    @Override
    public LATradingRecord createTradingRecord(RevokeRepayRequest request, CommandResponse response,
