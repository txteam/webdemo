 ...
 * @since  [产品/模块版本]
 */
public class RevokeNewLoanRequest extends AbstractRevokeLoanRequest {
    
    /** <默认构造函数> */
    public RevokeNewLoanRequest(String loanAccountId, String revokeTradingRecordId, String revokeReason) {
    ...
    public LATradingRecordTypeEnum getTradingRecordType() {
        return LATradingRecordTypeEnum.REVOKE_NEW_LOAN;
    }
}
