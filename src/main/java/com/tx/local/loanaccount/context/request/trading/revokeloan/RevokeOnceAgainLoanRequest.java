 ...
 * @since  [产品/模块版本]
 */
public class RevokeOnceAgainLoanRequest extends AbstractRevokeLoanRequest {
    
    /** <默认构造函数> */
    public RevokeOnceAgainLoanRequest(String loanAccountId, String revokeTradingRecordId, String revokeReason) {
    ...
    public LATradingRecordTypeEnum getTradingRecordType() {
        return LATradingRecordTypeEnum.REVOKE_AGAIN_LOAN;
    }
}
