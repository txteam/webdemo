...
import com.tx.local.loanaccount.context.request.trading.revokerepay.AbstractRevokeRepayRequest;
 ...
 * @since  [产品/模块版本]
 */
public abstract class AbstractRevokeRepayReceiver<PR extends AbstractRevokeRepayRequest>
    ...
    public void validateRequest(PR request, CommandResponse response, LoanAccount loanAccount,
        ...
        //撤销某一笔交易，如果存在，某交易的上一笔交易为该交易，则需一并退出，被撤销的，已到账交易，需要立即重新做进去
