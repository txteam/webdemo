 ...
 * @since  [产品/模块版本]
 */
public class ChangeToWaitOutsourceRequest extends AbstractChangeRequest {
    
    /** <默认构造函数> */
    public ChangeToWaitOutsourceRequest(String loanAccountId, RequestSourceTypeEnum sourceType) {
