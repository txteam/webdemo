...
/**
  ...
  * @since  [产品/模块版本]
  */
@Component("cddLoanAccountBuildReceiver")
public class CDDLoanAccountBuildReceiver extends AbstractLoanAccountBuildReceiver<LoanBillLoanAccountBuildRequest> {
    ...
    protected boolean isMatch(LoanBillLoanAccountBuildRequest request) {
        if (LoanAccountTypeEnum.CDD.equals(request.getLoanAccountType())) {
            return true;
        }
        return false;
    }
