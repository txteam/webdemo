...
/**
  ...
  * @since  [产品/模块版本]
  */
public interface KQSBSXFStrategy extends Strategy {
     ...
     * @param handler
     * @param tradingRecord
     * @param deductTask [参数说明]
     * 
     * @return void [返回类型说明]
     * @exception throws [异常类型] [异常说明]
     * @see [类、类#方法、类#成员]
     */
    public List<DeductFailChargeRecord> buildKQSBSXFChargeRecords(
