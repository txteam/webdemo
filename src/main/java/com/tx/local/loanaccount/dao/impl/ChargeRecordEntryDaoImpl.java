 ...
 * @since [产品/模块版本]
 */
@Component("chargeRecordEntryDao")
public class ChargeRecordEntryDaoImpl 
		extends MybatisBaseDaoImpl<ChargeRecordEntry, String>
		implements ChargeRecordEntryDao {
