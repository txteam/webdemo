 ...
 * @since [产品/模块版本]
 */
@Component("laClientBankAccountDao")
public class LAClientBankAccountDaoImpl 
		extends MybatisBaseDaoImpl<LAClientBankAccount, String>
		implements LAClientBankAccountDao {
