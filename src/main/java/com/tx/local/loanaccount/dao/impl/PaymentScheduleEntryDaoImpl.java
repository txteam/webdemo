 ...
 * @since [产品/模块版本]
 */
@Component("paymentScheduleEntryDao")
public class PaymentScheduleEntryDaoImpl 
		extends MybatisBaseDaoImpl<PaymentScheduleEntry, String>
		implements PaymentScheduleEntryDao {
