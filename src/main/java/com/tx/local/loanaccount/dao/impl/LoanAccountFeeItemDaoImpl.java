 ...
 * @since [产品/模块版本]
 */
@Component("loanAccountFeeItemDao")
public class LoanAccountFeeItemDaoImpl 
		extends MybatisBaseDaoImpl<LoanAccountFeeItem, String>
		implements LoanAccountFeeItemDao {
