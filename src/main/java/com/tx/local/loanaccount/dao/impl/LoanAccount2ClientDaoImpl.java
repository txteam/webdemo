 ...
 * @since [产品/模块版本]
 */
@Component("loanAccount2ClientDao")
public class LoanAccount2ClientDaoImpl 
		extends MybatisBaseDaoImpl<LoanAccount2Client, String>
		implements LoanAccount2ClientDao {
