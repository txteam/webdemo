 ...
 * @since [产品/模块版本]
 */
@Component("loanAccountDailyRecordDao")
public class LoanAccountDailyRecordDaoImpl 
		extends MybatisBaseDaoImpl<LoanAccountDailyRecord, String>
		implements LoanAccountDailyRecordDao {
