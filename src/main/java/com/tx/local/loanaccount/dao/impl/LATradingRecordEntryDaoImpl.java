 ...
 * @since [产品/模块版本]
 */
@Component("laTradingRecordEntryDao")
public class LATradingRecordEntryDaoImpl 
		extends MybatisBaseDaoImpl<LATradingRecordEntry, String>
		implements LATradingRecordEntryDao {
