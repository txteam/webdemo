 ...
 * @since [产品/模块版本]
 */
@Component("exemptRecordEntryDao")
public class ExemptRecordEntryDaoImpl 
		extends MybatisBaseDaoImpl<ExemptRecordEntry, String>
		implements ExemptRecordEntryDao {
