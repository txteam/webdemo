 ...
 * @since [产品/模块版本]
 */
@Component("deductFailChargeRecordDao")
public class DeductFailChargeRecordDaoImpl 
		extends MybatisBaseDaoImpl<DeductFailChargeRecord, String>
		implements DeductFailChargeRecordDao {
