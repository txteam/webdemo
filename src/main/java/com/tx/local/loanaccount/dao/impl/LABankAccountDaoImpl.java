...
import com.tx.local.loanaccount.dao.LABankAccountDao;
 ...
 * @since [产品/模块版本]
 */
@Component("laBankAccountDao")
public class LABankAccountDaoImpl extends
        MybatisBaseDaoImpl<LABankAccount, String> implements LABankAccountDao {
