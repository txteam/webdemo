 ...
 * @since  [产品/模块版本]
 */
@JsonIgnoreProperties({"tradingRecord","exemptRecord","paymentScheduleEntry"})
@Entity
@Table(name = "la_exempt_record_entry")
public class ExemptRecordEntry implements Serializable, ScheduleEntryAssociate {
    ...
    @JsonIgnore
    @ManyToOne
    @JoinColumn(name = "exemptRecordId")
    private ExemptRecord exemptRecord;
    ...
    /**
     * @return 返回 exemptRecord
     */
    public ExemptRecord getExemptRecord() {
        return exemptRecord;
    }
    
    /**
     * @param 对exemptRecord进行赋值
     */
    public void setExemptRecord(ExemptRecord exemptRecord) {
        this.exemptRecord = exemptRecord;
    }
