...
public enum LABankAccountTypeEnum implements BasicDataEnum{
    ...
    /** POS机还款 */
    POS_HK("POS_HK","POS机还款",RepayIntentionTypeEnum.TRANSFER_REPAY);
    ...
    /** <默认构造函数> */
    private LABankAccountTypeEnum(String key, String name, RepayIntentionTypeEnum repayIntentionType) {
        this.key = key;
        this.name = name;
    ...
    /** <默认构造函数> */
    private LABankAccountTypeEnum(String key, String name) {
        this.key = key;
        this.name = name;
