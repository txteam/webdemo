 ...
 * @since  [产品/模块版本]
 */
public class RepayAssignComparator implements Comparator<AssignEntryComparable> {
    ...
    /** <默认构造函数> */
    public RepayAssignComparator(LoanAccount loanAccount, Map<FeeItemEnum, FeeItemCfg> feeItemCfgMap,
        ...
        if (o1PeriodWeight > o2PeriodWeight) {
            ...
            if (o1Priority == o2Priority) {
                ...
                if (o1.getPeriod().equals(o2.getPeriod())) {
                    ...
                    return -1;
                } else if (NumberUtils.isDigits(o2.getPeriod()) && !NumberUtils.isDigits(o1.getPeriod())) {
                    return 1;
                } else {
