...
/**
 * PersonalSummary接口门面层[PersonalSummaryFacade]<br/>
 * 
 * @author []
 * @version [版本号]
 * @see [相关类/方法]
 * @since [产品/模块版本]
 */
public interface PersonalSummaryFacade {
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "新增PersonalSummary")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据ID删除PersonalSummary")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "修改PersonalSummary")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据主键查询PersonalSummary")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询PersonalSummary列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询PersonalSummary分页列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询PersonalSummary数量")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询PersonalSummary是否存在")
