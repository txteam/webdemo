 ...
 * @since [产品/模块版本]
 */
@Component("clientSocialAccountDao")
public class ClientSocialAccountDaoImpl 
		extends MybatisBaseDaoImpl<ClientSocialAccount, String>
		implements ClientSocialAccountDao {
