 ...
 */
@Component
public class ClientUsernameLogArgHandler implements LogArgumentHandler {
    
    private static final String FIELD_NAME = "clientUsername";
    ...
    public void handle(BeanWrapper bw) {
        bw.setPropertyValue(FIELD_NAME,
                ClientWebContextUtils.getClientUsername());
    }
}
