 ...
 * <修改描述:>
 */
package com.tx.local.servicelog.handler;
 ...
 */
@Component
public class UserTypeLogArgHandler implements LogArgumentHandler {
    
    private static final String FIELD_NAME = "userType";
    ...
    public boolean support(BeanWrapper bw) {
        try {
            ...
            if (!UserTypeEnum.class.equals(pd.getPropertyType())) {
                return false;
            }
    ...
    public void handle(BeanWrapper bw) {
        bw.setPropertyValue(FIELD_NAME, AbstractWebContextUtils.getUserType());
    }
}
