 ...
 */
@Component
public class OperatorUsernameLogArgHandler implements LogArgumentHandler {
    
    private static final String FIELD_NAME = "operatorUsername";
    ...
    public void handle(BeanWrapper bw) {
        bw.setPropertyValue(FIELD_NAME, WebContextUtils.getOperatorUsername());
    }
}
