 ...
 */
@Component
public class RemoteIpAddressLogArgHandler implements LogArgumentHandler {
    
    private static final String FIELD_NAME = "remoteIpAddress";
    ...
    public void handle(BeanWrapper bw) {
        bw.setPropertyValue(FIELD_NAME,
                WebUtils.getRemoteIpAddress(WebUtils.getRequest()));
    }
}
