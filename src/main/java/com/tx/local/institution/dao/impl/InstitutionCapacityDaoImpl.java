 ...
 * <修改描述:>
 */
package com.tx.local.institution.dao.impl;
...
import com.tx.local.institution.dao.InstitutionCapacityDao;
import com.tx.local.institution.model.InstitutionCapacity;

/**
 * InstitutionCapacity持久层
 * <功能详细描述>
 * 
 * @author  
 * @version [版本号]
 ...
 * @since [产品/模块版本]
 */
@Component("institutionCapacityDao")
public class InstitutionCapacityDaoImpl 
		extends MybatisBaseDaoImpl<InstitutionCapacity, String>
		implements InstitutionCapacityDao {
