 ...
 * @since [产品/模块版本]
 */
@Component("institutionSummaryInfoDao")
public class InstitutionSummaryInfoDaoImpl 
		extends MybatisBaseDaoImpl<InstitutionSummaryInfo, String>
		implements InstitutionSummaryInfoDao {
