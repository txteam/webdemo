...
/**
 * 消息附件接口门面层[MessageAttachmentFacade]<br/>
 * 
 * @author []
 * @version [版本号]
 * @see [相关类/方法]
 * @since [产品/模块版本]
 */
public interface MessageAttachmentFacade {
