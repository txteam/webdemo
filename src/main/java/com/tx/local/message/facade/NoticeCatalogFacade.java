...
/**
 * 公告消息分类接口门面层[NoticeCatalogFacade]<br/>
 * 
 * @author []
 * @version [版本号]
 * @see [相关类/方法]
...
public interface NoticeCatalogFacade {
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据ID删除公告消息分类")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据编码删除公告消息分类")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据主键查询公告消息分类")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据编码查询公告消息分类")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询公告消息分类分页列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询公告消息分类是否存在")
