...
/**
 * NoticeCatalog接口门面层[NoticeCatalogFacade]<br/>
 * 
 * @author []
 * @version [版本号]
 * @see [相关类/方法]
 * @since [产品/模块版本]
 */
public interface NoticeCatalogFacade {
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "新增NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据ID删除NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据编码删除NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "修改NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
	@ApiOperation(value = "禁用NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "启用NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据主键查询NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "根据编码查询NoticeCatalog")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询NoticeCatalog列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询NoticeCatalog分页列表")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询NoticeCatalog数量")
     ...
     * @see [类、类#方法、类#成员]
     */
    @ApiOperation(value = "查询NoticeCatalog是否存在")
