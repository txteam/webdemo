 ...
 * @since  [产品/模块版本]
 */
public class CalendarEventRRule {
    ...
    private ByWeekdayEnum[] byweekday;
    
    private ByMonthEnum[] bymonth;
     ...
     * @return 返回 byweekday
     */
    public ByWeekdayEnum[] getByweekday() {
        return byweekday;
    }
     ...
     */
    public void setByweekday(ByWeekdayEnum[] byweekday) {
     ...
     * @param 对bymonth进行赋值
     */
    public void setBymonth(ByMonthEnum[] bymonth) {
