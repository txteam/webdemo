...
public class OperatorCalendarController {
    ...
    public String index(@RequestParam Map<String, String> request,
            ModelMap response) {
        //return "/calendar/calendarMainTest";
    ...
    public String toQueryPagedList(@RequestParam Map<String, String> request,
            ModelMap response) {
        return "/calendar/queryOperatorCalendarEventPagedList";
    }
    ...
    public String toAddEvent(@RequestParam Map<String, String> request,
        ...
        return "/calendar/saveOperatorCalendarEvent";
    }
    ...
    public String toUpdateEvent(@RequestParam("id") String id,
        ...
        condition.setType(CalendarEventTypeEnum.OPERATOR_CALENDAR_EVENT);
