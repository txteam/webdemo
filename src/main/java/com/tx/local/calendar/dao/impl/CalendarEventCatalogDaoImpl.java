 ...
 * <修改描述:>
 */
package com.tx.local.calendar.dao.impl;
 ...
 * @since [产品/模块版本]
 */
@Component("calendarEventCatalogDao")
public class CalendarEventCatalogDaoImpl 
		extends MybatisBaseDaoImpl<CalendarEventCatalog, String>
		implements CalendarEventCatalogDao {
