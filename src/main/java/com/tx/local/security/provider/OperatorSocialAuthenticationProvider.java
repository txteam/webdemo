 ...
 * @since  [产品/模块版本]
 */
public class OperatorSocialAuthenticationProvider implements
    ...
    public boolean supports(Class<?> authentication) {
        return (OperatorSocialAuthenticationToken.class
    ...
    public Authentication authenticate(Authentication authentication)
            throws AuthenticationException {
        AssertUtils.isInstanceOf(OperatorSocialAuthenticationToken.class,
                authentication,
                messages.getMessage(
                        "AbstractUserDetailsAuthenticationProvider.onlySupports",
                        "Only OperatorSocialAuthenticationToken is supported"));
        
        // Determine userId
        String userId = (authentication.getPrincipal() == null)
                ? "NONE_PROVIDED"
                : ((OperatorSocialAuthenticationToken) authentication)
                        .getUserId();
    ...
    protected Authentication createSuccessAuthentication(Object principal,
        ...
        OperatorSocialAuthenticationToken result = new OperatorSocialAuthenticationToken(
     ...
     */
    public OperatorUserDetailsService getUserDetailsService() {
    ...
    public void setUserDetailsService(
            OperatorUserDetailsService userDetailsService) {
