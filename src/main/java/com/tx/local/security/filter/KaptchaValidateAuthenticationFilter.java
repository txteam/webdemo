...
public class KaptchaValidateAuthenticationFilter
    ...
    public static final String SPRING_SECURITY_FORM_CAPTCHA_CODE_KEY = "validate_code";
    
    public static final String SPRING_SECURITY_SESSION_CAPTCHA_CODE_KEY = "session_validate_code";
