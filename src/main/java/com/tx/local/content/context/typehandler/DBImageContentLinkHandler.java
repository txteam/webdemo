 ...
 * @since  [产品/模块版本]
 */
@Component("dbImageContentLinkHandler")
public class DBImageContentLinkHandler extends AbstractContentTypeHandler {
    
    /**
     * 数据库存储_图片内容链接类型 db_for_image_content_link
     * @return
     */
    @Override
    public String type() {
        return "dbImageContentLink";
    }
    ...
    public String remark() {
        return "存储内容至数据库,title为链接的悬停内容,contentFileId为图片id,content为图片存储相对路径.";
    }
