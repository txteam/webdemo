...
/**
 * 内容信息类型的业务层[ContentInfoTypeService]
 * <功能详细描述>
 * 
 * @author  
 * @version [版本号]
...
public class ContentInfoTypeService
        extends AbstractBasicDataService<ContentInfoType> {
    
    @SuppressWarnings("unused")
    private Logger logger = LoggerFactory
            .getLogger(ContentInfoTypeService.class);
    ...
    public void insert(ContentInfoType contentInfoType) {
        ...
        contentInfoType.setLastUpdateDate(new Date());
        contentInfoType.setValid(true);
        contentInfoType.setCreateDate(new Date());
    ...
    public List<ContentInfoType> queryList(Boolean valid,
        ...
        List<ContentInfoType> resList = this.contentInfoTypeDao
                .queryList(params);
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<ContentInfoType> queryList(Boolean valid, Querier querier) {
        //判断条件合法性
    ...
    public PagedList<ContentInfoType> queryPagedList(Boolean valid,
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        PagedList<ContentInfoType> resPagedList = this.contentInfoTypeDao
    ...
    public int count(Boolean valid, Querier querier) {
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        int res = this.contentInfoTypeDao.count(querier);
    ...
    public boolean exists(Map<String, String> key2valueMap, String excludeId) {
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        int res = this.contentInfoTypeDao.count(params, excludeId);
    ...
    public boolean exists(Querier querier, String excludeId) {
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        int res = this.contentInfoTypeDao.count(querier, excludeId);
     ...
     */
    @Transactional
    public boolean updateById(String id, ContentInfoType contentInfoType) {
        //验证参数是否合法，必填字段是否填写
        AssertUtils.notNull(contentInfoType, "contentInfoType is null.");
        AssertUtils.notEmpty(id, "id is empty.");
        ...
        updateRowMap.put("lastUpdateOperatorId",
                contentInfoType.getLastUpdateOperatorId());
    ...
    public boolean updateById(ContentInfoType contentInfoType) {
        ...
        boolean flag = updateById(contentInfoType.getId(), contentInfoType);
        //如果需要大于1时，抛出异常并回滚，需要在这里修改
        return flag;
    }
    ...
    public boolean disableById(String id) {
        ...
        boolean flag = this.contentInfoTypeDao.update(params) > 0;
