...
/**
 * 内容信息分类的业务层[ContentInfoCategoryService]
 * <功能详细描述>
 * 
 * @author  
 * @version [版本号]
...
public class ContentInfoCategoryService
        extends AbstractBasicDataService<ContentInfoCategory> {
    ...
    public void insert(ContentInfoCategory contentInfoCategory) {
        ...
        contentInfoCategory.setLastUpdateDate(new Date());
        contentInfoCategory.setValid(true);
        contentInfoCategory.setCreateDate(new Date());
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<ContentInfoCategory> queryList(Boolean valid, Querier querier) {
        //判断条件合法性
    ...
    public int count(Boolean valid, Querier querier) {
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        int res = this.contentInfoCategoryDao.count(querier);
    ...
    public boolean exists(Map<String, String> key2valueMap, String excludeId) {
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        int res = this.contentInfoCategoryDao.count(params, excludeId);
    ...
    public boolean exists(Querier querier, String excludeId) {
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        int res = this.contentInfoCategoryDao.count(querier, excludeId);
    ...
    public boolean updateById(String id,
            ContentInfoCategory contentInfoCategory) {
        //验证参数是否合法，必填字段是否填写
        AssertUtils.notNull(contentInfoCategory,
                "contentInfoCategory is null.");
        AssertUtils.notEmpty(id, "id is empty.");
        ...
        updateRowMap.put("lastUpdateOperatorId",
                contentInfoCategory.getLastUpdateOperatorId());
        ...
        updateRowMap.put("createOperatorId",
                contentInfoCategory.getCreateOperatorId());
        updateRowMap.put("modifyAble", contentInfoCategory.isModifyAble());
        updateRowMap.put("parent", contentInfoCategory.getParent());
        updateRowMap.put("remark", contentInfoCategory.getRemark());
        updateRowMap.put("lastUpdateDate", new Date());
        
        boolean flag = this.contentInfoCategoryDao.update(id, updateRowMap);
    ...
    public boolean updateById(ContentInfoCategory contentInfoCategory) {
        ...
        boolean flag = updateById(contentInfoCategory.getId(),
                contentInfoCategory);
        //如果需要大于1时，抛出异常并回滚，需要在这里修改
        return flag;
    }
    ...
    public boolean disableById(String id) {
        ...
        boolean flag = this.contentInfoCategoryDao.update(params) > 0;
