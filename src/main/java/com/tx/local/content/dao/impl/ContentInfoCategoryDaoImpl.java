 ...
 * @since [产品/模块版本]
 */
@Component("contentInfoCategoryDao")
public class ContentInfoCategoryDaoImpl 
		extends MybatisBaseDaoImpl<ContentInfoCategory, String>
		implements ContentInfoCategoryDao {
