 ...
 * @since [产品/模块版本]
 */
@Component("bankInfoServiceNew")
public class BankInfoServiceNew extends AbstractBasicDataService<BankInfo> {
    
    @SuppressWarnings("unused")
    private Logger logger = LoggerFactory.getLogger(BankInfoServiceNew.class);
    
    @Autowired
    private BankInfoDaoNew bankInfoDao;
