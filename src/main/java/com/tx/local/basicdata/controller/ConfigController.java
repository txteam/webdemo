...
public class ConfigController {
    ...
    public List<ConfigProperty> queryRootList(
        ...
        querier.getParams().put("leaf", false);
        
        List<ConfigProperty> resList = configContext.queryList(querier);
        return resList;
    }
    ...
    public List<ConfigProperty> queryChildrenByParentId(
        ...
        if (StringUtils.isEmpty(parentId)) {
            resList = configContext.queryList(querier);
        } else {
            resList = configContext.queryChildrenByParentId(parentId, querier);
        }
        return resList;
    }
