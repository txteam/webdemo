...
/**
  ...
  * @since  [产品/模块版本]
  */
public class FeeItemEnumJsonSerializable extends JsonSerializer<FeeItemEnum> {
     ...
     */
    @Override
    public void serialize(FeeItemEnum value, JsonGenerator generator, SerializerProvider serializers)
     ...
     * @see [类、类#方法、类#成员]
     */
    private boolean isIgnore(FeeItemEnum value, PropertyDescriptor pd) {
        try {
