 ...
 * <修改描述:>
 */
package com.tx.front4wap.security.filter;
...
import com.tx.front4client.security.model.ClientLoginFormAuthenticationToken;
 ...
 * @since  [产品/模块版本]
 */
public class WapClientAuthenticationProcessingFilter
        extends AbstractAuthenticationProcessingFilter {
    
    /** 日志记录句柄 */
    private Logger logger = LoggerFactory
            .getLogger(WapClientAuthenticationProcessingFilter.class);
    ...
    /** 验证码参数 */
    private String captchaParameter = SecurityConstants.CAPTCHA_FOR_CLIENT;
    
    /** 验证码session值 */
    private String captchaSessionAtrribute = SecurityConstants.SESSION_CAPTCHA_FOR_CLIENT;
    
    /** <默认构造函数> */
    public WapClientAuthenticationProcessingFilter() {
        super(new AntPathRequestMatcher("/wap/client/login", "POST"));
    }
    
    /** <默认构造函数> */
    public WapClientAuthenticationProcessingFilter(String loginProcessingUrl) {
    ...
    protected void setDetails(HttpServletRequest request,
            ClientLoginFormAuthenticationToken authRequest) {
        authRequest
