...
import com.tx.component.basicdata.model.BankEnum;
...
public class BankInfoService extends AbstractBasicDataService<BankInfo> {
    ...
    public void insert(BankInfo bankInfo) {
        ...
        bankInfo.setAliases(handleAliases(bankInfo.getAliases(),
                bankInfo.getName()));
    ...
    public boolean updateById(BankInfo bankInfo) {
        ...
        updateRowMap.put("institutionLoginUrl", bankInfo.getInstitutionLoginUrl());
