...
import com.tx.component.basicdata.service.BankInfoService;
...
public class BankInfoController {
    ...
    */
    ...
    public Map<String, String> validateCodeIsExist(
        ...
        boolean flag = this.bankInfoService.isExist(key2valueMap,
                excludeBankInfoId);
    ...
    */
    ...
    public PagedList<BankInfo> queryPagedList(
        ...
        PagedList<BankInfo> resPagedList = this.bankInfoService.queryPagedList(valid,
                params,
                pageIndex,
                pageSize);
        return resPagedList;
