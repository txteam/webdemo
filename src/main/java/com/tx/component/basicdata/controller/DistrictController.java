...
import com.tx.component.basicdata.model.DistrictTypeEnum;
...
public class DistrictController {
    ...
    */
    ...
    public Map<String, String> validateCodeIsExist(
        ...
        boolean flag = this.districtService.isExist(key2valueMap,
                excludeDistrictId);
    ...
    */
    ...
    public List<District> queryList(
        ...
        if(StringUtils.isEmpty(request.getFirst("parentIdLike"))) {
            ...
            parentIdLike = parentIdLike.substring(0, parentIdLike.indexOf("0000"));
    ...
    */
    ...
    public PagedList<District> queryPagedList(
        ...
        PagedList<District> resPagedList = this.districtService.queryPagedList(valid,
                params,
                pageIndex,
                pageSize);
        return resPagedList;
