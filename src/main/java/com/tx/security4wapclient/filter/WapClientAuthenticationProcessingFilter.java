 ...
 * <修改描述:>
 */
package com.tx.security4wapclient.filter;

import com.tx.local.security.SecurityConstants;
import com.tx.security.exception.CaptchaErrorException;
import com.tx.security4client.model.ClientLoginFormAuthenticationToken;
...
public class WapClientAuthenticationProcessingFilter
    ...
    public WapClientAuthenticationProcessingFilter() {
        super();
        setFilterProcessesUrl("/wap/client/sign");
    }
