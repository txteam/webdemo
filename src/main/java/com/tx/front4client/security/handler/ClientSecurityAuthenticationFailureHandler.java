 ...
 * <修改描述:>
 */
package com.tx.front4client.security.handler;
 ...
 * @since  [产品/模块版本]
 */
public class ClientSecurityAuthenticationFailureHandler
        extends SimpleUrlAuthenticationFailureHandler {
    
    /** 日志记录器 */
    private Logger logger = LoggerFactory
            .getLogger(ClientSecurityAuthenticationFailureHandler.class);
