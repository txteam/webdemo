...
public class TestUploadController {
    ...
    private String savePath = ConfigContext.getContext().getConfigPropertyValueByKey("test.upload.local.savePath");
    ...
    public boolean upload(@RequestParam(value = "requestId") String requestId,
        ...
        try {
            ...
            IOUtils.copy(processDefFile.getFileItem().getInputStream(), new FileOutputStream(
                    saveFile));
        } catch (IOException e) {
