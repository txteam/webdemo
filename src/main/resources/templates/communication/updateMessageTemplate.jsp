	...
	$('#messageTemplateForm').validator({
	    valid: function(){
			...
			$('#messageTemplateForm').ajaxSubmit({
			    url:"${contextPath }/messageTemplate/updateMessageTemplate.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("修改messageTemplate成功");
						parent.DialogUtils.closeDialogById("updateMessageTemplate");
					}else{
						parent.DialogUtils.tip("修改messageTemplate失败");
					}
			    } 
			});
			return false;
