	...
	$('#sMSMessageSendRecordForm').validator({
	    valid: function(){
			...
			$('#sMSMessageSendRecordForm').ajaxSubmit({
			    url:"${contextPath }/sMSMessageSendRecord/addSMSMessageSendRecord.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("新增sMSMessageSendRecord成功");
						parent.DialogUtils.closeDialogById("addSMSMessageSendRecord");
					}else{
						parent.DialogUtils.tip("新增sMSMessageSendRecord失败");
					}
			    } 
			});
			return false;
