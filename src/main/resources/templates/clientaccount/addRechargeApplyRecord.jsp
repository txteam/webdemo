	...
	$('#rechargeApplyRecordForm').validator({
	    valid: function(){
			...
			$('#rechargeApplyRecordForm').ajaxSubmit({
			    url:"${contextPath }/rechargeApplyRecord/addRechargeApplyRecord.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("新增rechargeApplyRecord成功");
						parent.DialogUtils.closeDialogById("addRechargeApplyRecord");
					}else{
						parent.DialogUtils.tip("新增rechargeApplyRecord失败");
					}
			    } 
			});
			return false;
		...
		<form:form id="rechargeApplyRecordForm" method="post" cssClass="form"
			...
			<table class="common_table">
				<tr>
					...
					<th class="narrow" width="20%">virtualAccountName:</th>
					<td width="80%">
						<form:input path="virtualAccountName" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
				...
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">rechargeDate:</th>
					<td width="80%">
						<form:input path="rechargeDate" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">clientUserName:</th>
					<td width="80%">
						<form:input path="clientUserName" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">paymentOrderId:</th>
					<td width="80%">
						<form:input path="paymentOrderId" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">virtualAccountNumber:</th>
					<td width="80%">
						<form:input path="virtualAccountNumber" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
				...
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">clientPhoneNumber:</th>
					<td width="80%">
						<form:input path="clientPhoneNumber" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
