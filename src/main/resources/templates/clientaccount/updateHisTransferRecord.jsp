	...
	$('#hisTransferRecordForm').validator({
	    valid: function(){
			...
			$('#hisTransferRecordForm').ajaxSubmit({
			    url:"${contextPath }/hisTransferRecord/updateHisTransferRecord.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("修改hisTransferRecord成功");
						parent.DialogUtils.closeDialogById("updateHisTransferRecord");
					}else{
						parent.DialogUtils.tip("修改hisTransferRecord失败");
					}
			    } 
			});
			return false;
