...
<script type="text/javascript">
	$ (document).ready (function (){
	    ...
	    $ ('#form').validator (
	    {
		    valid : function ()
		    {
			    ...
			    $ ('#form').ajaxSubmit (
			    {
			        url : "${contextPath }/transferApplyRecord/approveToReject.action",
			        success : function (data)
			        {
				        ...
				        if (data)
				        {
					        ...
					        parent.DialogUtils.tip ("审批驳回处理完成.");
					        parent.DialogUtils.closeDialogById ("transferApplySuccess");
				        }
				        else
				        {
					        parent.DialogUtils.tip ("审批驳回处理失败。");
				        }
			        }
			    });
			    return false;
    ...
    function cancelFun ()
    {
	    parent.DialogUtils.closeDialogById ("transferApplyReject");
    }
</script>
</head>
<body>
