	...
	$('#cashoutRecordForm').validator({
	    valid: function(){
			...
			$('#cashoutRecordForm').ajaxSubmit({
			    url:"${contextPath }/cashoutRecord/updateCashoutRecord.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("修改cashoutRecord成功");
						parent.DialogUtils.closeDialogById("updateCashoutRecord");
					}else{
						parent.DialogUtils.tip("修改cashoutRecord失败");
					}
			    } 
			});
			return false;
