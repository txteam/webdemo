	...
	timeoutHandler = setTimeout(function(){
		...
		if(taxmentScheduleGrid){
			taxmentScheduleGrid.datagrid('resize',{
				width: $("#taxsettle_schedule").innerWidth()
			});
		}
		*/
	}, 1500);
					...
					<tbody>
						<tr valign="top">
							<td width="23%" style="vertical-align: top;">
								<table>
									...
									<tr>
										...
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getFeeItemRatePercent('DK_LX')}" pattern="#,##0.00#"/>%
										</td>
									</tr>
									<tr>
									    <th class="narrow">管理费率(年)：</th>
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getFeeItemRatePercent('ZX_GLF')}" pattern="#,##0.00#"/>%
										</td>
									</tr>
									<tr>
									    <th class="narrow">违约金费率：</th>
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getFeeItemRatePercent('DK_TQHKWYJ')}" pattern="#,##0.00#"/>%
										</td>
									</tr>
									<tr>
							...
							<td width="30%" style="vertical-align: top;">
								<table>
									<tr>
										<th class="narrow" width="66%"></th>
										<th class="narrow" align="right" width="17%" style="text-align: right;">贷款方</th>
										<th class="narrow" align="right" width="17%" style="text-align: right;">中介方</th>
									</tr>
									<tr>
										<th class="narrow">已收贷款总额：</th>
										<th align="center" colspan="2" class="narrow" style="text-align: center;">
									...
									<tr>
										...
										<td>&nbsp;</td>
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getActualReceivedSum('MAIN','ZX_GLF')}" pattern="#,##0.00#"></fmt:formatNumber>
											 /<fmt:formatNumber value="${loanAccountDetail.getExemptSum('MAIN','ZX_GLF') }" pattern="#,##0.00#"></fmt:formatNumber>
										</td>
									</tr>
									<tr>
										...
										<td align="right">
											<fmt:formatNumber value="${loanAccountDetail.getActualReceivedSum('MAIN','ZX_YCXSXF')}" pattern="#,##0.00#"/>
										</td>
									</tr>
									<!-- 
									<tr>
									...
									<tr>
										...
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getActualReceivedSum('MAIN','ZX_DQYQF')}" pattern="#,##0.00#"/>
										</td>
									</tr>
									<tr>
										...
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getActualReceivedSum('MAIN','ZX_KQSBSXF')}" pattern="#,##0.00#"/>/
											<fmt:formatNumber value="${loanAccountDetail.getExemptSum('MAIN','ZX_KQSBSXF')}" pattern="#,##0.00#"/>
										</td>
									</tr>
									<tr>
										...
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getActualReceivedSum('MAIN','ZX_YQLX')}" pattern="#,##0.00#"/>/
											<fmt:formatNumber value="${loanAccountDetail.getExemptSum('MAIN','ZX_YQLX')}" pattern="#,##0.00#"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td  align="right">
											<fmt:formatNumber value="${loanAccountDetail.getActualReceivedSum('MAIN','ZX_WBYJ')}" pattern="#,##0.00#"/>/
											<fmt:formatNumber value="${loanAccountDetail.getExemptSum('MAIN','ZX_WBYJ')}" pattern="#,##0.00#"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td  align="right" colspan="2">${loanAccountDetail.overRepayAmount}</td>
									</tr>
								</table>
							</td>
		        ...
		        <table id="overdueInfoGrid">
		          ...
		          <tbody>
		            ...
		            <tr>
			            ...
			            <td>-</td>
			            <td>
			            	<fmt:formatNumber value="${loanAccountDetail.getSum('MAIN','DK_YQLX') + loanAccountDetail.getSum('MAIN','ZX_YQLX')}" pattern="#,##0.00#"/>
			            	<c:set var="totalSum" value="${totalSum + loanAccountDetail.getSum('MAIN','DK_YQLX') + loanAccountDetail.getSum('MAIN','ZX_YQLX')}"></c:set>
			            </td>
			            <td>
 ...
 */
function revokeFun(){
	$.post("${contextPath}/loanAccountRevoke/getRevokeAbleTradingRecords.action",{loanAccountId:'${loanAccountDetail.id}'},function(data){
		if($.ObjectUtils.isEmpty(data)){
			DialogUtils.alert("提醒：", "不存在可被撤销的交易记录.", "info");
		}else{
			var tradingRecordId  = data[0].id;
			parent.DialogUtils.openModalDialog(
				"revoke",
				"撤销交易",
				$.formatString("${contextPath}/loanAccountRevoke/toRevoke.action?revokeCategory=REVOKE_TRADING&loanAccountId=${loanAccountDetail.id}&revokeTradingRecordId={0}",tradingRecordId),
				800,350,function(){
				window.location.reload();
			});
		}
