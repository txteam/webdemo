	...
	$('#entityForm').validator({
	    valid: function(){
			...
			$('#entityForm').ajaxSubmit({
			    url:"${contextPath }/noticeMessage2Client/update.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("修改noticeMessage2Client成功.");
						parent.DialogUtils.closeDialogById("updateNoticeMessage2Client");
					}else{
						DialogUtils.alert("错误提示","修改noticeMessage2Client失败.","error");
					}
			    } 
			});
			return false;
