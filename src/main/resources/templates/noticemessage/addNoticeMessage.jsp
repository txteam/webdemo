	...
	$('#entityForm').validator({
	    valid: function(){
			...
			$('#entityForm').ajaxSubmit({
			    url:"${contextPath }/noticeMessage/add.action",
			    success: function(data) {
			    	DialogUtils.progress('close');
					if(data){
						parent.DialogUtils.tip("新增noticeMessage成功.");
						parent.DialogUtils.closeDialogById("addNoticeMessage");
					}else{
						DialogUtils.alert("错误提示","新增noticeMessage失败.","error");
					}
			    } 
			});
			return false;
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form:form id="entityForm" method="post" cssClass="form"
			...
			<table class="common_table">
				...
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">noticeMessageType.id</th>
					<td width="80%">
						//TODO:修改其显示逻辑
						<form:input path="noticeMessageType" cssClass="text"/>
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
				...
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
					<th class="narrow" width="20%">publishDate:</th>
					<td width="80%">
						<form:input path="publishDate" cssClass="text" />
					</td>
				</tr>
				<tr>
					<!--//TODO:修改字段是否必填,修改其中文名-->
